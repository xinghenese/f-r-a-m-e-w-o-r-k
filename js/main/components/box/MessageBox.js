        ...
        var box = (
            <div className="messagebox" style={makeStyle(style)}>
                ...
                <div className="messagebox-footer" style={makeStyle(style.footer)}>
                    <input type="button" value={Lang.confirm}
                           style={makeStyle(style.button, style.footer ? style.footer.confirm : void 0)}/>
                    <input type="button" value={Lang.cancel}
                           style={makeStyle(style.button, style.footer ? style.footer.cancel : void 0)}/>
                </div>
            </div>
        );
